    ...
    // 52044_v10 changes: Adding  Dhaka Narita Dhaka in destinations list 20 JULY 2023
    // 52044_v11 changes: Adding Additional CAN ROUTES 11SEP23  
    ...
    $.each(airportName, function() {
        options.append($("<option />").val(this.iata_code).text("<span class=\"badge badge-light\">"+this.airport_name +"</span> <span class=\"badge badge-light\">"+this.country +"</span>, " + this.city + " <span class=\"badge badge-primary\">" + this.iata_code + "</span>"));
                ...
                $.each(airportName, function() {
                    if (this.iata_code == to_airport) {
                        destinationOptions.append($("<option/>").val(this.iata_code)
                            .text("<span class=\"badge badge-light\">"+this.airport_name +"</span> <span class=\"badge badge-light\">"+this.country +"</span>, " + this.city + " <span class=\"badge badge-primary\">" + this.iata_code + "</span> ")
                        );
                    }
    ...
    $.each(airportName, function() {
        options2.append($("<option />").val(this.iata_code).text("<span class=\"badge badge-light\">"+this.airport_name +"</span> <span class=\"badge badge-light\">"+this.country +"</span>, " + this.city + " <span class=\"badge badge-primary\">" + this.iata_code + "</span> "));
    });
