    ...
    $.each(airportName, function() {
        options.append($("<option />").val(this.iata_code).text("<span style='font-size: .85rem; font-weight: 100'>"+this.airport_name +"</span> <span style='font-size: .85rem;'>"+this.country +"</span>, " + this.city + " <span style='float: right; margin-top: .4rem; margin-top: .4rem' class=\"badge badge-primary\">" + this.iata_code + "</span>"));
                ...
                $.each(airportName, function() {
                    if (this.iata_code == to_airport) {
                        destinationOptions.append($("<option/>").val(this.iata_code)
                            .text("<span style='font-size: .85rem; font-weight: 100'>"+this.airport_name +"</span> <span style='font-size: .85rem;'>"+this.country +"</span>, " + this.city + " <span style='float:right; margin-top: .4rem' class=\"badge badge-primary\">" + this.iata_code + "</span> ")
                        );
                    }
    ...
    $.each(airportName, function() {
        options2.append($("<option />").val(this.iata_code).text("<span style='font-size: .85rem; font-weight: 100'>"+this.airport_name +"</span> <span style='font-size: .85rem;'>"+this.country +"</span>, " + this.city + " <span style='float: right;  margin-top: .4rem' class=\"badge badge-primary\">" + this.iata_code + "</span> "));
    });
    ...
    $.each(airportName, function() {
        optionsFlightStatus.append($("<option />").val(this.iata_code).text(" <span style='font-size: .85rem; font-weight: 100'>"+this.airport_name+"</span> <span style='font-size: .85rem;'>"+this.country + ", " + this.city + " <span style='float: right; margin-top: .4rem' class=\"badge badge-primary\">" + this.iata_code + "</span>"));
        // options.append($("<option />").val(this.iata_code).text(this.city + " (" + this.iata_code + ") "));
    });
                ...
                $.each(airportName, function() {
                    if (this.iata_code == to_airport) {
                        optionsFlightStatusArrival.append($("<option/>").val(this.iata_code)
                            .text(" <span style='font-size: .85rem; font-weight: 100'>"+this.airport_name +"</span> <span style='font-size: .85rem;'>"+this.country + ", " + this.city + " <span style='float: right; margin-top: .4rem' class=\"badge badge-primary\">" + this.iata_code + "</span>")
                        );
                    }
    ...
    $.each(airportName, function() {
        optionsFlightSchedule.append($("<option />").val(this.iata_code).text(" <span style='font-size: .85rem; font-weight: 100'>"+this.airport_name+"</span> <span style='font-size: .85rem;'>"+this.country + ", " + this.city + " <span style='float: right; margin-top: .4rem' class=\"badge badge-primary\">" + this.iata_code + "</span>"));
        // options.append($("<option />").val(this.iata_code).text(this.city + " (" + this.iata_code + ") "));
    });
    ...
    $.each(airportName, function() {
        optionsDepartMultiCity.append($("<option />").val(this.iata_code).text(" <span style='font-size: .85rem; font-weight: 100'>"+this.airport_name+"</span> <span style='font-size: .85rem;'>"+this.country + ", " + this.city + " <span style='float: right; margin-top: .4rem' class=\"badge badge-primary\">" + this.iata_code + "</span>"));
        // options.append($("<option />").val(this.iata_code).text(this.city + " (" + this.iata_code + ") "));
    });
    ...
    $.each(airportName, function() {
        optionsDepartMultiCity1.append($("<option />").val(this.iata_code).text(" <span style='font-size: .85rem; font-weight: 100'>"+this.airport_name +"</span> <span style='font-size: .85rem;'>"+ this.country + ", " + this.city + " <span style='float: right; margin-top: .4rem' class=\"badge badge-primary\">" + this.iata_code + "</span>"));
        // options.append($("<option />").val(this.iata_code).text(this.city + " (" + this.iata_code + ") "));
    });
