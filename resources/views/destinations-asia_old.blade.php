                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/bangkok-grid-1.jpg')}}" alt="bangkok-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/bangkok-grid-2.jpg')}}" alt="bangkok-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/bangkok-grid-3.jpg')}}" alt="bangkok-img">
                                    {{-- <a href="room-details.html" class="d-block">
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Bangkok</h3>
                                
                                {{-- <p class="card-text pt-2">Parts of Thailand's capital are ablaze with neon at night, roar with traffic by day, and amid the ramshackle chaos, there's always something colorful to draw your eye. From gold-spired buddhist temples and monks' robes to flowers in a hidden market and the t-shirts of touts. It's a vast, tropical, assault on the senses and home to 11 million. Pack your curiosity, fortitude and sense of adventure. Bangkok is ready for you.</p> --}}
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/Guangzhou-grid-1.jpg')}}" alt="guangzhou-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/Guangzhou-grid-2.jpg')}}" alt="guangzhou-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/Guangzhou-grid-3.jpg')}}" alt="guangzhou-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Guangzhou</h3>
                                {{-- <p class="card-text pt-2">Guangzhou also known as Canton and alternately romanized as Kwangchow, is the capital and most populous city of the province of Guangdong in Southern China. The city features avant-garde architecture such as zaha hadid’s Guangzhou opera house (known as the “double pebble”); the carved box-shaped Guangzhou museum.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                                    City in China
                                    {{-- <ul class="d-flex align-items-center">
                                        <li class="d-flex align-items-center"><i class="la la-plane"></i><span>2 Beds</span></li>
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/hongkong-grid-1.jpg')}}" alt="hongkong-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/hongkong-grid-2.jpg')}}" alt="hongkong-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/hongkong-grid-3.jpg')}}" alt="hongkong-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Hong Kong</h3>
                                {{-- <p class="card-text pt-2">Hong Kong, officially the Hong Kong special administrative region of the people's republic of China, is a metropolitan area and special administrative region of the people's republic of China on the eastern pearl river delta of the South China Sea.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/kualalumpur-grid-1.jpg')}}" alt="kualalumpur-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/kualalumpur-grid-2.jpg')}}" alt="kualalumpur-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/kualalumpur-grid-3.jpg')}}" alt="kualalumpur-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/singapore-grid-1.jpg')}}" alt="singapore-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/singapore-grid-2.jpg')}}" alt="singapore-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/singapore-grid-3.jpg')}}" alt="singapore-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
...
================================= -->
{{-- @extends('destinations-search-widget') --}}
{{-- @section("destinations-search-widget")
@endsection --}}
