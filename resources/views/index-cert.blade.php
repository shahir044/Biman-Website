                            ...
                            <div class="tab-pane fade show active" id="flight" role="tabpanel"
                                ...
                                <div class="section-tab section-tab-3">
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <strong>Dhaka to Japan!</strong> Discover our exciting new inaugural route from Dhaka to Japan with discounted fares.
                    ...
                    <div class="discount-box">
                        ...
                        <div class="discount-content">
                            <div class="section-heading">
                                ...
                                <p class="sec__desc text-white pt-2">Applicable for All Routes Except Canada & UK</p>
                                <p class="sec__desc text-white pt-2">Limited Time Offer. Book Now Online</p>
    ...
    <section class="gallery-area section-padding">
        ...
        <div class="full-width-slider padding-top-50px carousel-action">
            <div class="full-width-slide-item">
                <a class="d-block" data-fancybox="gallery" href="{{ asset('assets/images/offers/newyear23.jpg') }}" data-caption="Discounts & Offers">
                    <img src="{{ asset('assets/images/offers/newyear23.jpg') }}" alt="Subcontinent">
                </a>
            </div><!-- end full-width-slide-item -->
            <div class="full-width-slide-item">
                <a class="d-block" data-fancybox="gallery" href="{{ asset('assets/images/offers/CGP-ZYL-Offer-ENG.jpg') }}" data-caption="Discounts & Offers">
                    <img src="{{ asset('assets/images/offers/CGP-ZYL-Offer-ENG.jpg') }}"
                         alt="Subcontinent">
                </a>
            </div><!-- end full-width-slide-item -->
            <div class="full-width-slide-item">
                <a class="d-block" data-fancybox="gallery" href="https://www.youtube.com/watch?v=Vyt1akjqsGc&feature=youtu.be" target="_blank" data-caption="How to buy your ticket">
                    <img src="{{ asset('assets/images/offers/howto.jpg') }}">
                </a>
            </div><!-- end full-width-slide-item -->
            ...
            <div class="col-lg-7">
                <div class="about-content pr-5">
                    <div class="section-heading">
                        ...
                        <h2 class="cd-headline rotate-1 font-size-30 text-black display-6 font-weight-bolder line-height-45">
                            <span id="typeElement">
                            </span>
                        </h2>
                    </div><!-- end section-heading -->
                    {{-- <div class="btn-box pt-4">
                        <a target="_blank" href="https://youtu.be/Vyt1akjqsGc" class="theme-btn">Watch Now<i class="la la-external-link-alt ml-1 font-size-18"></i></a>
                    </div> --}}
                </div>
            </div><!-- end col-lg-6 -->
            <div class="col-lg-5">
                <div class="image-box about-img-box">
                    <a target="_blank" href="https://youtu.be/Vyt1akjqsGc"><img src="{{ asset('assets/images/offers/newyear23.jpg') }}" alt="about-img" class="img__item img__item-1"></a>
                ...
                <div class="row padding-top-50px">
                    ...
                    <div class="col-lg-4">
                        <a href="{{ route('destinations-europe') }}">
                            <div class="card-item destination-card">
                                <div class="card-img">
                                    <img src="{{ asset('assets/images/destinations/london-index-1.jpg') }}" alt="Europe">
                        ...
                        <a href="https://www.biman-airlines.com/news-details/33">
                            <div class="card-item destination-card">
                                <div class="card-img">
                                    <img src="{{ asset('assets/images/destinations/toronto-index.jpg') }}" alt="North America">
                            ...
                            <div class="testimonial-card">
                                ...
                                <div class="author-content d-flex align-items-center">
                                    ...
                                    <div class="author-bio">
                                        ...
                                        <span class="author__meta"><a href="{{ route('news-details', ['id' => $item->id]) }}"
                                            class="btn-text">Read details<i class="la la-angle-right"></i></a></span>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                <div class="section-heading">
                    ...
                    <h2 class="sec__title font-size-30 text-white">Join Our Loyalty Club Today</h2>
                    <p class="sec__desc text-white-50 pb-1">Enjoy the rewards of membership, earn miles, and get access to special offers.</p>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-7 -->
            <div class="col-lg-5">
                <div class="subscriber-box">
                    <div class="contact-form-action text-right">
                        <a class="theme-btn theme-btn-large" href="{{ route('loyalty.register') }}"><i class="la la-user-plus font-size-18"></i> Become a Member</a>
                    </div>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-5 -->
        </div><!-- end row -->
     ...
     <div class="modal-dialog modal-dialog-centered modal-lg">
         <div class="modal-content" style="width:90%; position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%);">
             ...
             <div style="" class="modal-body">
                  ...
                  <a href="">
                      <img  style="display: block; width: 100%; height:100%" src="{{ asset('assets/images/offers/CGP-ZYL-Offer-ENG.jpg') }}">
                  </a>
...
@section('page-specific-footer')
    ...
    <script>
        var typed = new Typed('#typeElement', {
            strings: ['Hello there. Greetings from BIMAN. <br>It is our top priority to make your journey comfortable and safe. Book your flight right away.<br>Let\'s Fly with BIMAN.'],
            typeSpeed: 90,
        });
    </script>
