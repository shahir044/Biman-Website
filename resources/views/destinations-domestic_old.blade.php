                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/dhaka-grid-1.jpg')}}" alt="dhaka-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/dhaka-grid-2.jpg')}}" alt="dhaka-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/dhaka-grid-3.jpg')}}" alt="dhaka-img">
                                    {{-- <a href="room-details.html" class="d-block">
                            ...
                            <div class="card-body">
                                {{-- <div class="card-price pb-2">
                                    <p>
                                        <span class="price__from">The capital of Bangladesh</span>
                                        <span class="price__num"></span>
                                    </p>
                                </div> --}}
                                <h3 class="card-title font-size-26">Dhaka</h3>
                                {{-- <p class="card-text pt-2">The Capital Of Bangladesh, Dhaka is the largest city in the nation. the city is known to be a colorful, congested and thriving metropolis with a population of 18 million. Dhaka is also known the city of masjid/mosque.</p> --}}
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/barishal-grid-1.jpg')}}" alt="barishal-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/barishal-grid-2.jpg')}}" alt="barishal-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/barishal-grid-3.jpg')}}" alt="barishal-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                {{-- <div class="card-price pb-2">
                                    <p>
                                        ...
                                        <span class="price__num"> 3500 BDT (Inc. TAX)*</span>
                                    </p>
                                </div> --}}
                                <h3 class="card-title font-size-26">Barishal</h3>
                                {{-- <p class="card-text pt-2">Barishal is a major city that lies on the bank of Kirtankhola river in the south-central Bangladesh. It is the largest city and the administrative headquarter of both Barishal district and Barishal division.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                                    On the banks of the Kirtankhola River
                                    {{-- <ul class="d-flex align-items-center">
                                        <li class="d-flex align-items-center"><i class="la la-plane"></i><span>2 Beds</span></li>
                                        <li class="d-flex align-items-center"><i class="la la-building"></i><span>24 ft<sup>2</sup></span></li>
                                        <li class="d-flex align-items-center"><i class="la la-bathtub"></i><span>2 Bathrooms</span></li>
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/chattogram-grid-1.jpg')}}" alt="chattogram-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/chattogram-grid-2.jpg')}}" alt="chattogram-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/chattogram-grid-3.jpg')}}" alt="chattogram-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Chattogram</h3>
                                {{-- <p class="card-text pt-2">The Chittagonian enthusiasm for inviting people to massive feasts is a bit of legend both locally and elsewhere in Bangladesh. known as Mezbani these feasts feature a tremendously hot curry, usually of beef.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                                    A large port city
                                    {{-- <ul class="d-flex align-items-center">
                                        <li class="d-flex align-items-center"><i class="la la-plane"></i><span>2 Beds</span></li>
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/cox-grid-1.jpg')}}" alt="coxsbazar-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/cox-grid-2.jpg')}}" alt="coxsbazar-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/cox-grid-3.jpg')}}" alt="coxsbazar-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                {{-- <div class="card-price pb-2">
                                    <p>
                                        <span class="price__from">Fare Starts From</span>
                                        <span class="price__num"> 4400 BDT (Inc. TAX)*</span>
                                    </p>
                                </div> --}}
                                <h3 class="card-title font-size-26">Cox's Bazar</h3>
                                {{-- <p class="card-text pt-2">Cox's Bazar is the longest unbroken 120 km sandy sea beach with a gentle slope. Cox's Bazar is a town, a fishing port and district headquarters in Bangladesh. Cox's Bazar is located 150 km south of the industrial port Chattogram.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/jashore-grid-1.jpg')}}" alt="jashore-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/jashore-grid-2.jpg')}}" alt="jashore-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/jashore-grid-3.jpg')}}" alt="jashore-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Jashore</h3>
                                {{-- <p class="card-text pt-2">Jashore is a district in the southwestern region of Bangladesh. It is bordered by India to the west, Khulna district and Satkhira district to the south, Magura and Narail to the east, and Jhenaidah district to the north.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                                    City in the southwestern region
                                    {{-- <ul class="d-flex align-items-center">
                                        <li class="d-flex align-items-center"><i class="la la-plane"></i><span>2 Beds</span></li>
                                        <li class="d-flex align-items-center"><i class="la la-building"></i><span>24 ft<sup>2</sup></span></li>
                                        <li class="d-flex align-items-center"><i class="la la-bathtub"></i><span>2 Bathrooms</span></li>
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/rajshahi-grid-1.jpg')}}" alt="rajshahi-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/rajshahi-grid-2.jpg')}}" alt="rajshahi-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/rajshahi-grid-3.jpg')}}" alt="rajshahi-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Rajshahi</h3>
                                {{-- <p class="card-text pt-2">Rajshahi nicknamed silk city is a major urban, commercial and educational centre of north bengal. It is the administrative city of Rajshahi division & Rajshahi district located on the north bank of the Padma river.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                                    On the north bank of the Padma River
                                    {{-- <ul class="d-flex align-items-center">
                                        <li class="d-flex align-items-center"><i class="la la-plane"></i><span>2 Beds</span></li>
                                        <li class="d-flex align-items-center"><i class="la la-building"></i><span>24 ft<sup>2</sup></span></li>
                                        <li class="d-flex align-items-center"><i class="la la-bathtub"></i><span>2 Bathrooms</span></li>
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/sylhet-grid-1.jpg')}}" alt="sylhet-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/sylhet-grid-2.jpg')}}" alt="sylhet-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/sylhet-grid-3.jpg')}}" alt="sylhet-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Sylhet</h3>
                                {{-- <p class="card-text pt-2">Sylhet, the "spiritual capital of Bangladesh" is known in bengal as the "city of saints". It is home to mausoleums and mosques of shah jalal and shah paran, bengal’s most revered sufi saints.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                    ...
                    <div class="col-lg-4">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/saidpur-grid-1.jpg')}}" alt="saidpur-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/saidpur-grid-2.jpg')}}" alt="saidpur-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/saidpur-grid-3.jpg')}}" alt="saidpur-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Saidpur</h3>
                                {{-- <p class="card-text pt-2">Saidpur is a city of Nilphamari district in Rangpur division of Bangladesh. The city becomes a very important communication hub for adjoining major district headquarters.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                                    A very important communication hub
                                    {{-- <ul class="d-flex align-items-center">
                                        <li class="d-flex align-items-center"><i class="la la-plane"></i><span>2 Beds</span></li>
                                        <li class="d-flex align-items-center"><i class="la la-building"></i><span>24 ft<sup>2</sup></span></li>
                                        <li class="d-flex align-items-center"><i class="la la-bathtub"></i><span>2 Bathrooms</span></li>
