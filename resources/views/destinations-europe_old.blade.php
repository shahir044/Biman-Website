                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/london-grid-1.jpg')}}" alt="london-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/london-grid-2.jpg')}}" alt="london-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/london-grid-3.jpg')}}" alt="london-img">
                                    {{-- <a href="room-details.html" class="d-block">
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">London</h3>
                                {{-- <p class="card-text pt-2">London is a leading global city with all the associated trappings, delights and sights. Built on roman and medieval foundations, cut by the river thames, it is now a vast home to more than 8 million where 300 languages are spoken. A thriving capital of culture, trade, finance, politics and fashion, the city comprises 32 boroughs, all of which have a distinctive character.</p> --}}
                    ...
                    <div class="col-lg-6">
                        <div class="card-item room-card">
                            <div class="card-img-carousel carousel-action carousel--action">
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/manchester-grid-1.jpg')}}" alt="manchester-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="{{asset('assets/images/destinations/bangladesh-index.jpg')}}" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/manchester-grid-2.jpg')}}" alt="manchester-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img29.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                                <div class="card-img">
                                    <img src="{{asset('assets/images/destinations/manchester-grid-3.jpg')}}" alt="manchester-img">
                                    {{-- <a href="room-details.html" class="d-block">
                                        <img src="images/img30.jpg" alt="hotel-img">
                                    </a> --}}
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title font-size-26">Manchester</h3>
                                {{-- <p class="card-text pt-2">Manchester is a city and metropolitan borough in greater manchester, england. Manchester is a major city in the northwest of england with a rich industrial heritage. The castle field conservation area’s 18th-century canal system recalls the city’s days as a textile powerhouse, and visitors can trace this history at the interactive museum of science & industry.</p> --}}
                                <div class="card-attributes pt-3 pb-4">
                                    City in England
                                    {{-- <ul class="d-flex align-items-center">
                                        <li class="d-flex align-items-center"><i class="la la-plane"></i><span>2 Beds</span></li>
