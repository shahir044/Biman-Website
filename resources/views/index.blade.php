        ...
        <span class="line-bg line-bg1"></span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tab-content search-fields-container search-fields-container-shape" id="myTabContent">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <p class="sec__desc pt-3">Top picks of our passengers</p>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
                ...
                <div class="car-wrap">
                    <div class="car-carousel carousel-action">
                        <div class="card-item destination-card">
                            <div class="card-img">
                                <img src="{{asset('assets/images/destination-img_600x845/destination-img_600x845.png')}}" alt="destination-img">
                                <span class="badge">Makkah</span>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card-item destination-card">
                            <div class="card-img">
                                <img src="{{asset('assets/images/destination-img_600x845/destination-img_600x845 (1).png')}}" alt="destination-img">
                                <span class="badge">Rome</span>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card-item destination-card">
                            <div class="card-img">
                            <img src="{{asset('assets/images/destination-img_600x845/destination-img_600x845 (2).png')}}" alt="destination-img">
                        ...
                        <div class="card-item destination-card">
                            <div class="card-img">
                                <img src="{{asset('assets/images/destination-img_600x845/destination-img_600x845 (3).png')}}" alt="destination-img">
                                <span class="badge">Narita</span>
                            </div>
                            <div class="card-body">
                                <h3 class="card-title"><a href="tour-details.html">Narita, Japan</a></h3>
                            </div>
                        </div><!-- end card-item -->
                        <div class="card-item destination-card">
                            <div class="card-img">
                            <img src="{{asset('assets/images/destination-img_600x845/destination-img_600x845 (4).png')}}" alt="destination-img">
                                <span class="badge">Kathmandu</span>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card-item destination-card">
                            <div class="card-img">
                            <img src="{{asset('assets/images/destination-img_600x845/destination-img_600x845 (5).png')}}" alt="destination-img">
                ...
                <div class="row padding-top-50px">
                    <div class="col-lg-12">
                        <a href="{{ route('destinations-domestic') }}">
                            <div class="card-item destination-card">
                                <div class="card-img">
                                    <img src="{{ asset('assets/images/destination-img_600x845/route-map_1200x600.png') }}"
                                        alt="destinations">
                                </div>
                            </div>
                        </a>
