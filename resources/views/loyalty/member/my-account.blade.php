...
================================= -->
    <section class="user-area padding-top-100px padding-bottom-60px">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="title font-size-24">Account Summary</h3>
                    <div class="card-item user-card card-item-list mt-4 mb-0">
                        <div class="card-img">
                            <img src="{{asset('assets/images/loyalty/team7.jpg')}}" alt="user image" class="h-auto">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Member Card Information</h3>
                            <div class="d-flex justify-content-between pt-3">
                                <ul class="list-items list-items-3 flex-grow-1">
                                    <li><span class="font-weight-bold">Member Number:</span>9017232039</li>
                                    <li><span class="font-weight-bold">Tier:</span>Register</li>
                                    <li><span class="font-weight-bold">Available Award Miles:</span>1,000</li>
                                    <li><span class="font-weight-bold">To Next Tier:</span>15,000 Qualifying Miles or 20 Segments by 2022/08/31</li>
                                    <li><span class="font-weight-bold"> Current Qualifying Period:</span>From: 2021/08/01 to: 2022/08/31</li>
                                    <li><span class="font-weight-bold">Total Qualifying Miles:</span><a href="#">0</a></li>
                                    <li><span class="font-weight-bold">Total qualifying segments</span><a href="#">0</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card-item user-card card-item-list mt-2 mb-0">
                                    ...
                                    <ul class="list-items list--items list-group list-items-flush">
                                        ...
                                        <li>
                                            <a href="{{route('loyalty.register')}}">
                                                <i class="la la-arrow-right"></i> My Profile
                                            </a>
                                        </li>
                                    ...
                                    <ul class="list-items list--items list-group list-items-flush">
                                        <li>
                                            <a href="{{route('loyalty.earn')}}">
                                                <i class="la la-arrow-right"></i> Flight Mileage Claim
                                            </a>
                                        </li>
                                    </ul>
                                    <ul class="list-items list--items list-group list-items-flush">
                                        <li>
                                            <a href="{{route('loyalty.redeem')}}">
                                                <i class="la la-arrow-right"></i> Redeem Miles
                                            </a>
                                        </li>
                                    </ul>
                                    <ul class="list-items list--items list-group list-items-flush">
                                        <li>
                                            <a href="{{route('loyalty.lounge')}}">
                                                <i class="la la-arrow-right"></i> Change Password
                                            </a>
                                        </li>
                                    </ul>
                                </div>
