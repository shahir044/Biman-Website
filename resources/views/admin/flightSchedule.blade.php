...
@section('content')
    ...
    <div class="block block-rounded">
        <div class="block-header">
            <h2>DOMESTIC Flight Schedule</h2>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <div class="form-group">
                            <h4>DOMESTIC Flight Schedule Excel file</h4>
                            <div class="custom-file">
                            <form action="{{ route('submitFile') }}" method="POST" enctype="multipart/form-data" name="Form">
                                    @csrf
                                ...
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="d-none d-sm-table-cell badge badge-success" style="width: 30%; text-align:center">Udploaded at</th>
                                            <th class="d-none d-sm-table-cell badge badge-success" style="width: 15%; text-align:center">Uploaded by</th>
                                            <th class="d-none d-sm-table-cell badge badge-success" style="width: 15%; text-align:center">Download</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($domesticFiles as $file)
